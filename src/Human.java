...
public class Human extends Agent{
	...
	private int fireTime = 10; //Duree de l'agent en feu

	private int deathAge = 600; //age maximum

	private int maxHealth = 300; //Sante maximale
	private int minHealth = 150; //Sante minimale
	private double ploseHealth = 0.75; //probabilite de perdre de la vie

	private int minStime = 15; //Duree minimale avant de pouvoir avoir un enfant
	private int maxStime = 30; //Duree maximale avant de pouvoir avoir un enfant
